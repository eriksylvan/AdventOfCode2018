...
public class Day_07_test extends TestCase {
    ...
    protected static String[] input = { "Step C must be finished before step A can begin.",
    ...
    public void testPartTwo_2() {
        String[] testinp = { "Step C must be finished before step D can begin.",
                "Step B must be finished before step D can begin.", "Step A must be finished before step C can begin.",
    ...
    public void testSolutionPartTwo() {
        ...
        int expected = 980;
        int actual = day_07.day07PartTwo(indata, 5, 60);
        assertEquals("expected: " + expected + " actual: " + actual, expected, actual);
    }
